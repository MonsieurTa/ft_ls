...
/*   Updated: 2018/12/11 15:22:19 by fwerner          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** Initialise les fields de chaque fichiers de lst et le fmt pour un
** affichage complet. Retourne -1 en cas d'erreur et 0 en cas de succes.
*/
int		init_all_fields_and_fmt(t_opts *opts, t_lst_ls *lst, t_fmt *fmt);
